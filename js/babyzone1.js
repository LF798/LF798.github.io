 ...
 **************************************************/
 ...
 //babyzone在JS中可以作为一个对象来引用，该对象具有scroll()方法
 babyzone = function () {  
	...
	return {
		...
		scroll : function(count,wrapId,ulId,infoId) {
			...
			this.info=id(infoId);
				...
				(this.num[0]=frag.appendChild(document.createElement("li"))).innerHTML="皮肤限时销售";
				(this.num[1]=frag.appendChild(document.createElement("li"))).innerHTML="2021幸运一夏";
				(this.num[2]=frag.appendChild(document.createElement("li"))).innerHTML="LPL今日赛程";
				(this.num[3]=frag.appendChild(document.createElement("li"))).innerHTML="S11城市发布";
				(this.num[4]=frag.appendChild(document.createElement("li"))).innerHTML="泳池派对";
